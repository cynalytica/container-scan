...
exports.getFilteredOutput = exports.getSeveritiesToInclude = exports.getTrivyHtmlOutputPath = exports.getTrivySarifOutputPath = exports.getTrivyLogPath = exports.getOutputPath = exports.getTrivy = exports.runTrivy = exports.runTrivyTemplate = exports.SEVERITY_UNKNOWN = exports.SEVERITY_LOW = exports.SEVERITY_MEDIUM = exports.SEVERITY_HIGH = exports.SEVERITY_CRITICAL = exports.trivyToolName = exports.TRIVY_EXIT_CODE = void 0;
...
const trivyLatestReleaseUrl = "https://api.github.com/repos/aquasecurity/trivy/releases/tags/v0.22.0";
...
;
function runTrivyTemplate(imageName, template, outputPath) {
    return __awaiter(this, void 0, void 0, function* () {
        let trivyResult;
        try {
            const trivyPath = yield getTrivy();
            const trivyOptions = yield getTrivyExecOptionsTemplate(imageName, template, outputPath);
...
exports.runTrivyTemplate = runTrivyTemplate;
...
function getTrivyHtmlOutputPath(image) {
    const iName = image.replace(reReplace, "_");
    return `${fileHelper.getContainerScanDirectory()}/${iName}.html`;
}
exports.getTrivyHtmlOutputPath = getTrivyHtmlOutputPath;
...
function getTrivyEnvVariablesTemplate(image, template, outputPath) {
    return __awaiter(this, void 0, void 0, function* () {
        let trivyEnv = {};
        for (let key in process.env) {
            trivyEnv[key] = process.env[key] || "";
...
function getTrivyExecOptionsTemplate(image, template, outputPath) {
    return __awaiter(this, void 0, void 0, function* () {
        const trivyEnv = yield getTrivyEnvVariablesTemplate(image, template, outputPath);
        return {
            env: trivyEnv,
            ignoreReturnCode: true,
            outStream: fs.createWriteStream(getTrivyLogPath(image))
