...
exports.getFilteredOutput = exports.getSeveritiesToInclude = exports.printFormattedOutput = exports.getSummary = exports.getText = exports.getTrivyLogPath = exports.getOutputPath = exports.getTrivy = exports.runTrivy = exports.SEVERITY_UNKNOWN = exports.SEVERITY_LOW = exports.SEVERITY_MEDIUM = exports.SEVERITY_HIGH = exports.SEVERITY_CRITICAL = exports.trivyToolName = exports.TRIVY_EXIT_CODE = void 0;
...
function getText(image, trivyStatus) {
...
function getSummary(image, trivyStatus) {
    let summary = '';
    switch (trivyStatus) {
        case 0:
...
function printFormattedOutput(image) {
    let rows = [];
...
function getVulnerabilityIdsBySeverity(image, trivyStatus, removeDuplicates) {
