...
function reopenIssue(issue_number) {
    return __awaiter(this, void 0, void 0, function* () {
        yield client.rest.issues.update(Object.assign(Object.assign({}, github.context.repo), { issue_number, state: 'open' }));
        yield client.rest.issues.createComment(Object.assign(Object.assign({}, github.context.repo), { issue_number, body: `Issue has been reopened due to being found again.` }));
    });
}
function removeLabelFromIssue(issue_number, name) {
    return __awaiter(this, void 0, void 0, function* () {
        yield client.rest.issues.removeLabel(Object.assign(Object.assign({}, github.context.repo), { issue_number, name }));
    });
}
function issueCanBeFixedNow(issue_number, fixedVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        yield removeLabelFromIssue(issue_number, 'no-fix');
