...
exports.createAnIssue = exports.getIssuesList = exports.issues = exports.SecurtiyLabels = exports.getSecurityLevel = exports.SecurityLevels = void 0;
...
const client = github.getOctokit(inputHelper_1.githubToken, { throttle: {
...
function getIssuesList(client) {
    return __awaiter(this, void 0, void 0, function* () {
        if (exports.issues.length == 0) {
            exports.issues = yield client.paginate(client.rest.issues.listForRepo, Object.assign({}, github.context.repo));
        }
...
function createAnIssue(issuesList, issue, fixedVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (issueExists !== -1) {
                ...
                exports.issues.push(newIssue); //prevent duplication from US
            }
        }
        catch (e) {
            core.error(e);
