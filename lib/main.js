...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var images_1 = __asyncValues(images), images_1_1; images_1_1 = yield images_1.next(), !images_1_1.done;) {
                const i = images_1_1.value;
                yield runImage(i);
            }
        }
            ...
            try {
                if (images_1_1 && !images_1_1.done && (_a = images_1.return)) yield _a.call(images_1);
            }
...
function createIssueFromVuln(vuln, imageName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((0, createIssue_1.getSecurityLevel)(inputHelper.minSeverity) >= (0, createIssue_1.getSecurityLevel)(vuln.severity)) {
            //figure out labels
        ...
        `;
            const issue = {
                title,
                body,
                labels: createIssue_1.SecurtiyLabels[vuln.severity],
            };
            yield issueHelper.createAnIssue(issue);
        }
    });
}
